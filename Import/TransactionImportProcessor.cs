...
namespace trackr.Import
{
    public class TransactionImportProcessor
    {
        ...
        public static TransactionImportResult ProcessImport(IEnumerable<Transaction> importedTransactions, IEnumerable<Transaction> existingTransactions, BankAccount account)
        {
